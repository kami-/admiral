...
adm_cqc_fnc_getZoneBuildings = {
    ...
    _buildings = [nearestObjects [GET_ZONE_POSITION(_zone), ["HouseBase"], _zoneRadius], {[getPosATL _x, GET_ZONE_AREA(_zone), GET_ZONE_POSITION(_zone)] call adm_common_fnc_isPositionInArea}] call BIS_fnc_conditionalSelect;
