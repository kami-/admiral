...
#define SPAWN_CHANCE_ARG_CLASS              Admiral_SpawnChance
...
#define PATROL_VARS [ \
    [QUOTE(PATROL_INFANTRY_POOL_ARG_CLASS), "pool"], \
    [QUOTE(PATROL_TECHNICAL_POOL_ARG_CLASS), "pool"], \
    [QUOTE(PATROL_ARMOUR_POOL_ARG_CLASS), "pool"] \
]

#define PERIODIC_VARS [ \
    [QUOTE(CAMP_INFANTRY_POOL_ARG_CLASS), "pool"], \
    [QUOTE(CAMP_TECHNICAL_POOL_ARG_CLASS), "pool"], \
    [QUOTE(CAMP_ARMOUR_POOL_ARG_CLASS), "pool"], \
    [QUOTE(INFANTRY_WAVE_ARG_CLASS), "wave"], \
    [QUOTE(TECHNICAL_WAVE_ARG_CLASS), "wave"], \
    [QUOTE(ARMOUR_WAVE_ARG_CLASS), "wave"], \
    [QUOTE(CAMP_DELAY_ARG_CLASS), "campDelay"], \
    [QUOTE(INFANTRY_GROUP_DELAY_ARG_CLASS), "groupDelay"], \
    [QUOTE(TECHNICAL_GROUP_DELAY_ARG_CLASS), "groupDelay"], \
    [QUOTE(ARMOUR_GROUP_DELAY_ARG_CLASS), "groupDelay"] \
]

#define ONDEMAND_VARS [ \
    [QUOTE(CAMP_INFANTRY_POOL_ARG_CLASS), "pool"], \
    [QUOTE(CAMP_TECHNICAL_POOL_ARG_CLASS), "pool"], \
    [QUOTE(CAMP_ARMOUR_POOL_ARG_CLASS), "pool"], \
    [QUOTE(INFANTRY_WAVE_ARG_CLASS), "wave"], \
...
#define RANDOM_VARS [ \
    ...
    [QUOTE(ARMOUR_WAVE_ARG_CLASS), "wave"], \
    [QUOTE(CAMP_DELAY_ARG_CLASS), "campDelay"], \
    [QUOTE(SPAWN_CHANCE_ARG_CLASS), "spawnChance"] \
]