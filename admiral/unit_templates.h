class UnitTemplates {
    ...
    class MNP_USMC_WD {
        side = "west";
        camouflage[] = {"woodland"};
        infantry[] = {"MNP_USMC_Soldier_O", "MNP_USMC_Soldier_AR", "MNP_USMC_Soldier_F", "MNP_USMC_Soldier_AT", "MNP_USMC_Soldier_MG", "MNP_USMC_Soldier_IAR", "MNP_USMC_Soldier_AT", "MNP_USMC_Soldier_IAR", "MNP_USMC_Soldier_AT"};
    ...
    class MNP_USMC_DE {
        ...
        technicals[] = {"CUP_B_HMMWV_M2_GPK_USA", "CUP_B_HMMWV_Crows_M2_USA", "CUP_B_HMMWV_M2_USA", "CUP_B_HMMWV_M2_USA", "CUP_B_HMMWV_MK19_USA", "CUP_B_RG31E_M2_USMC", "CUP_B_RG31_M2_USMC", "CUP_B_RG31_Mk19_USMC"};
        armour[] = {"CUP_B_LAV25_USMC", "CUP_B_LAV25_USMC", "CUP_B_AAV_USMC", "CUP_B_M1A1_DES_US_Army"};
    };
    ...
    class MNP_US_RAN {
        ...
        technicals[] = {"CUP_B_HMMWV_M2_GPK_USA", "CUP_B_HMMWV_M2_GPK_USA", "CUP_B_HMMWV_Crows_MK19_USA", "CUP_B_HMMWV_SOV_USA", "CUP_B_RG31E_M2_USMC", "CUP_B_RG31_M2_USMC", "CUP_B_RG31_Mk19_USMC"};
    ...
    class MNP_US_WD {
        ...
        armour[] = {"CUP_B_M113_USA", "CUP_B_M113_USA", "CUP_B_M2Bradley_USA_W", "CUP_B_M1A1_Woodland_US_Army"};
    };
    ...
    class IF44_GER_WD {
        side = "west";
        camouflage[] = {};
        infantry[] = {"U_LIB_GER_ober_lieutenant", "U_LIB_GER_mgunner", "U_LIB_GER_soldier_K98", "U_LIB_GER_AT_grenadier", "U_LIB_GER_smgunner", "U_LIB_GER_mgunner", "U_LIB_GER_AT_grenadier", "U_LIB_GER_mgunner", "U_LIB_GER_AT_soldier"};
        crewmen[] = {"U_LIB_GER_tank_officer", "U_LIB_GER_spg_crew"};
        technicals[] = {"LIB_Kfz1"};
    ...
    class MNP_RU_VDV_WD {
        ...
        technicals[] = {"CUP_O_UAZ_MG_RU", "CUP_O_UAZ_MG_RU", "CUP_O_UAZ_MG_RU", "CUP_O_UAZ_AGS30_RU", "CUP_O_UAZ_SPG9_RU"};
        armour[] = {"CUP_O_BRDM2_SLA", "CUP_O_BRDM2_SLA", "CUP_O_BRDM2_SLA", "CUP_O_BTR90_RU", "CUP_O_BMP2_RU", "CUP_O_T72_RU"};
    };
    ...
    class MNP_RU_HWD {
        ...
        technicals[] = {"CUP_O_UAZ_MG_RU", "CUP_O_UAZ_MG_RU", "CUP_O_UAZ_MG_RU", "CUP_O_UAZ_AGS30_RU", "CUP_O_UAZ_SPG9_RU"};
        armour[] = {"CUP_O_BRDM2_SLA", "CUP_O_BRDM2_SLA", "CUP_O_BMP3_RU", "CUP_O_BTR90_RU", "CUP_O_T72_RU"};
    };
    ...
    class MNP_RU_WD {
        ...
        technicals[] = {"CUP_O_UAZ_MG_RU", "CUP_O_UAZ_MG_RU", "CUP_O_UAZ_MG_RU", "CUP_O_UAZ_AGS30_RU", "CUP_O_UAZ_SPG9_RU"};
        armour[] = {"CUP_O_BRDM2_RU", "CUP_O_BRDM2_RU", "CUP_I_BMP1_TK_GUE", "CUP_O_BMP2_RU", "CUP_O_BMP2_RU", "CUP_O_BMP3_RU", "CUP_O_T72_RU"};
    };
    ...
    class MNP_RU_TTK {
        ...
        technicals[] = {"CUP_O_UAZ_MG_RU", "CUP_O_UAZ_MG_RU", "CUP_O_UAZ_MG_RU", "CUP_O_UAZ_AGS30_RU", "CUP_O_UAZ_SPG9_RU"};
        armour[] = {"CUP_O_BRDM2_SLA", "CUP_O_BRDM2_SLA", "CUP_O_BTR60_SLA", "CUP_O_BMP2_RU", "CUP_O_BMP2_RU", "CUP_I_BMP1_TK_GUE", "CUP_I_T55_TK_GUE", "CUP_O_T72_RU"};
    };
    ...
    class MNP_RU_AIR {
        ...
        technicals[] = {"CUP_O_UAZ_MG_RU", "CUP_O_UAZ_MG_RU", "CUP_O_UAZ_MG_RU", "CUP_O_UAZ_AGS30_RU", "CUP_O_UAZ_SPG9_RU"};
        armour[] = {"CUP_O_BRDM2_SLA", "CUP_O_BRDM2_SLA", "CUP_O_BMP2_RU", "CUP_O_BMP2_RU", "CUP_I_BMP1_TK_GUE", "CUP_I_T55_TK_GUE", "CUP_I_T55_TK_GUE", "CUP_O_BTR60_SLA", "CUP_O_BTR60_SLA"};
    };

    class MNP_RU_REED {
        side = "east";
        camouflage[] = {"woodland"};
        infantry[] = {"MNP_RO4_Soldier_O", "MNP_RO4_Soldier_F", "MNP_RO4_Soldier_F", "MNP_RO4_Soldier_G", "MNP_RO4_Soldier_MG", "MNP_RO4_Soldier_AR", "MNP_RO4_Soldier_AT", "MNP_RO4_Soldier_AR", "MNP_RO4_Soldier_AT"};
        crewmen[] = {"MNP_RO4_Soldier_F", "MNP_RO4_Soldier_O"};
        technicals[] = {"CUP_O_UAZ_MG_RU", "CUP_O_UAZ_MG_RU", "CUP_O_UAZ_MG_RU", "CUP_O_UAZ_AGS30_RU", "CUP_O_UAZ_SPG9_RU"};
        armour[] = {"CUP_O_BRDM2_RU", "CUP_O_BRDM2_RU", "CUP_I_BMP1_TK_GUE", "CUP_O_BMP2_RU", "CUP_O_BMP2_RU", "CUP_O_BMP3_RU", "CUP_O_T72_RU"};
    };
    ...
    class MNP_IRN_QF_DE {
        side = "east";
        camouflage[] = {"desert"};
        infantry[] = {"MNP_IRN_DE_QF_Soldier_O", "MNP_IRN_DE_QF_Soldier_F", "MNP_IRN_DE_QF_Soldier_F", "MNP_IRN_DE_QF_Soldier_G", "MNP_IRN_DE_QF_Soldier_MG", "MNP_IRN_DE_QF_Soldier_AR", "MNP_IRN_DE_QF_Soldier_AT", "MNP_IRN_DE_QF_Soldier_AR", "MNP_IRN_DE_QF_Soldier_AT"};
        crewmen[] = {"MNP_IRN_DE_QF_Soldier_F", "MNP_IRN_DE_QF_Soldier_O"};
        technicals[] = {"CUP_O_UAZ_MG_RU", "CUP_O_UAZ_MG_RU", "CUP_O_UAZ_MG_RU", "CUP_O_UAZ_AGS30_RU", "CUP_O_UAZ_SPG9_RU"};
        armour[] = {"CUP_O_BRDM2_SLA", "CUP_O_BTR60_SLA", "CUP_O_BRDM2_SLA", "CUP_O_BRDM2_SLA", "CUP_I_BMP1_TK_GUE", "UP_O_BMP2_SLA", "CUP_O_T72_SLA"};
    };
    ...
    class CUP_SLA_WD {
        ...
        technicals[] = {"CUP_O_UAZ_MG_RU", "CUP_O_UAZ_MG_RU", "CUP_O_UAZ_MG_RU", "CUP_O_UAZ_AGS30_RU", "CUP_O_UAZ_SPG9_RU"};
        armour[] = {"CUP_O_BRDM2_SLA", "CUP_O_BTR60_SLA", "CUP_O_BTR60_SLA", "CUP_O_BRDM2_SLA", "CUP_O_BRDM2_SLA", "CUP_I_BMP1_TK_GUE", "CUP_O_BMP2_SLA", "CUP_O_T72_SLA"};
    };
    ...
    class CUP_RU_WD {
        ...
        technicals[] = {"CUP_O_UAZ_MG_RU", "CUP_O_UAZ_MG_RU", "CUP_O_UAZ_MG_RU", "CUP_O_UAZ_AGS30_RU", "CUP_O_UAZ_SPG9_RU"};
        armour[] = {"CUP_O_BRDM2_RU", "CUP_O_BRDM2_RU", "CUP_O_BRDM2_RU", "CUP_I_BMP1_TK_GUE", "CUP_O_BMP2_RU", "CUP_O_BMP2_RU", "CUP_O_BMP3_RU", "CUP_O_T72_RU"};
    };
    ...
    class IF44_USSR_WD {
        side = "east";
        camouflage[] = {};
        infantry[] = {"U_LIB_SOV_first_lieutenant", "U_LIB_SOV_mgunner", "U_LIB_SOV_rifleman", "U_LIB_SOV_AT_grenadier", "U_LIB_SOV_smgunner", "U_LIB_SOV_mgunner", "U_LIB_SOV_AT_grenadier", "U_LIB_SOV_mgunner", "U_LIB_SOV_AT_soldier"};
        crewmen[] = {"U_LIB_SOV_tank_crew", "U_LIB_SOV_tank_sergeant"};
    ...
    class CUP_RACS_DE {
        ...
        armour[] = {"CUP_I_M113_RACS", "CUP_I_M113_RACS", "CUP_I_M113_RACS", "CUP_I_T72_RACS", "CUP_I_T72_RACS"};
    };
    ...
    class IF44_USA {
        side = "resistance";
        camouflage[] = {};
        infantry[] = {"U_LIB_US_first_lieutenant", "U_LIB_US_mgunner", "U_LIB_US_rifleman", "U_LIB_US_grenadier", "U_LIB_US_smgunner", "U_LIB_US_mgunner", "U_LIB_US_grenadier", "U_LIB_US_mgunner", "U_LIB_US_AT_soldier"};
        crewmen[] = {"U_LIB_US_tank_crew", "U_LIB_US_tank_sergeant"};
